		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<span class="text-uppercase text-sm letter-spacing ">Akaryakıt Sektöründe TEK !</span>
					<h1 class="mb-3 mt-3">Kalite ve Güvenin Adresi Kozan Kantar Petrol Ofisi.</h1>
					
					<div class="btn-container ">
						<a href="appoinment.html" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Randevu Al<i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<span>24 Saat Servis ve Hizmet</span>
						<h4 class="mb-3">Randevu Sistemi</h4>
						<p class="mb-4">Gün içerisinde 8:00 - 18:00 arası araç bakım hizmeti</p>
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<span>Zaman Şablonu</span>
						<h4 class="mb-3">Servis Çalışma Saatleri</h4>
						<ul class="w-hours list-unstyled">
		                    <li class="d-flex justify-content-between">Pazartesi - Çarşamba : <span>8:00 - 18:00</span></li>
		                    <li class="d-flex justify-content-between">Perşembe - Cuma : <span>8:00 - 18:00</span></li>
		                    <li class="d-flex justify-content-between">Cumartesi - Pazar : <span>8:00 - 18:00</span></li>
		                </ul>
					</div>
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<h4 class="mb-3">(0322)515 16 17</h4>
						<p>Hafta içi her gün saat 08:00 - 18:00 arası yolda kalan araçlar için yakıt hizmeti!</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-4">
				<div class="about-content pl-4 mt-4 mt-lg-0">
					<h2 class="title-color">Araç Sağlığı <br>& Bakım Uzmanı</h2>
					<p class="mt-4 mb-5">Araçlarınızı gün içerisinde güvenle teslim edebilir ve kaliteli bakım malzemeleri ile hizmet alabilirsiniz.</p>

					<a href="service.html" class="btn btn-main-2 btn-round-full btn-icon">Servis<i class="icofont-simple-right ml-3"></i></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<h2>Ödül Kazanan Hizmet</h2>
					<div class="divider mx-auto my-4"></div>
					<p>Hizmet ve kaliteden ötürü alınan 'Yüksek Hizmet Ödülü' !</p>
				</div>
			</div>
		</div>
		...
		<div class="row align-items-center">
			<div class="col-lg-6 ">
				<div class="appoinment-content">
					<img src="images/about/img-3.jpg" alt="" class="img-fluid">
					<div class="emergency">
						<h2 class="text-lg"><i class="icofont-phone-circle text-lg"></i>(0322) 515 16 17</h2>
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-md-10 ">
				<div class="appoinment-wrap mt-5 mt-lg-0">
					<h2 class="mb-2 title-color">Randevu Sistemi</h2>
					<p class="mb-4">Aşağıda yer alan boşlukları uygun şekilde doldurarak hızlı ve güvenli bir şekilde randevunuzu alabilirsiniz.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <select class="form-control" id="exampleFormControlSelect2">
                                    ...
                                    <option>Coşkun Kaymaz</option>
                                    <option>Şener Ünlü</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input name="date" id="date" type="text" class="form-control" placeholder="Tarih">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                             ...
                             <a class="btn btn-danger btn-round-full" href="appoinment.html">Randevu Al<i class="icofont-simple-right ml-2"></i></a>
                </form>
            </div>
			</div>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7">
				<div class="section-title text-center">
					<h2>Binlerce Müşteriye Verilen Kaliteli Hizmet</h2>
					<div class="divider mx-auto my-4"></div>
				</div>
			</div>
		</div>
    ...
    <div class="container">
        ...
        <div class="footer-btm py-4 mt-5">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6">
                    <div class="copyright">
                        &copy; Copyright Reserved to <span class="text-color">Ömer BOZ</span> by <a href="https://www.petrolofisi.com.tr" target="_blank">POAS</a>
                    </div>
                </div>
                <div class="col-lg-6">
