...
<head>
  ...
  <meta name="author" content="poas.com">
...
<section class="section about-page">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h2 class="title-color">Tarihçe</h2>
			</div>
			<div class="col-lg-8">
				<p>Petrol Ofisi, kamu ve özel sektör kuruluşları ile nihai tüketicilerin gereksinimi için petrol ve petrol ürünleri satın almak, ithal etmek ve ülkenin tümünü kapsayacak şekilde stoklar oluşturup pazarlamasını yapmak amacıyla 1941 yılında, Ankara’da dokuz personelli bir kamu kuruluşu olarak faaliyete başladı. Simgesi ağzından alev çıkan dişi kurttur; bu simge Türk mitolojisinin temel figürlerinden olan dişi kurt Asena’ya dayanmaktadır.</p>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block mb-4">
						...
						<h4 class="mt-2"><a href="tel:+905334163686">kozankantar@poas.com</a></h4>
					</div>
					...
					<div class="footer-contact-block">
						...
						<h4 class="mt-2"><a href="tel:(0322) 515 16 17">(0322) 515 16 17</a></h4>
					</div>
				</div>
			</div>
		</div>
